<?php
    ...
    class Alumno extends Usuario{
        ...
        public function muestraAlumnosGrupos(){
            ...
            for($i = 0; $i < $cuantos; $i++){
                ...
                if($asignado == ""){
                    ...
                    echo"<tr><td><center>$nombre $apat $amat, asignado(a) al grupo $grupo<a href='TestAlumno.php?id=$id_alu'> Desasignar</a></center></td></tr>";
                }
            }
        ...
        public function muestraGrupos(){
            ...
            echo"<table class=table table-bordered>";
            echo"<tr>";
            echo"<td><center>Grupo: <select name=grupo>";
